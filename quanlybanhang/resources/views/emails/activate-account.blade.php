<table style="width: 100%; border-spacing: 0px">
    <tr>
        ...
        <td style="border-top: 1px solid black;border-bottom: 1px solid black;border-right: 1px solid black; text-align: center; vertical-align: middle; padding: 5px;">
            <h1 style="color: red;">Quản lý bán hàng NenTang</h1>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border-bottom: 1px solid black;border-right: 1px solid black; padding: 5px;">{!! $data['last_name'] . $data['first_name'] !!}</td>
    </tr>
    <tr>
